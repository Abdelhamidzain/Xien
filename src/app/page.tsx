        ...
        <div className="flex md:flex-col gap-1 overflow-x-auto md:overflow-x-visible pb-2 md:pb-0">
          {experience.map((e, i) => (
            ...
            >
              ...
              <span className={`text-[13px] font-bold uppercase tracking-wide block ${i === selected ? "text-white" : "text-white/30"
                }`}>
                {e.company}
              </span>
            </button>
                  ...
                  <div className="space-y-4 pt-2">
                    {[
                      ...
                      <div key={f.l} className="flex justify-between border-b border-white/[0.06] pb-3">
                        ...
                        <span className="text-[12px] text-white/60 text-right ml-4 line-clamp-2">{f.v}</span>
                      </div>
                    ))}
              ...
              <div className="section-inner">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center gap-5">
                    ...
                    <a href="mailto:Abdelhamid.zainhom@gmail.com" className="text-[14px] text-white/60 hover:text-[#00C853] transition-colors">Abdelhamid.zainhom@gmail.com</a>
                  </div>
                  <div className="flex items-center gap-5">
                    <span className="label-mono w-16">Phone</span>
                    <a href="tel:0563787025" className="text-[14px] text-white/60 hover:text-[#00C853] transition-colors">0563787025</a>
                  </div>
                  <div className="flex items-center gap-5">
                    <span className="label-mono w-16">Location</span>
                    <span className="text-[14px] text-white/60">Riyadh — Saudi Arabia</span>
                  </div>
                </div>
